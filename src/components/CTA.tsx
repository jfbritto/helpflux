      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="relative rounded-3xl overflow-hidden">
          ...
          <div className="relative z-10 px-8 py-16 md:px-16 md:py-20 text-center">
            ...
            >
              Quer conhecer nossos produtos de perto?
            </h2>
            <p className="text-green-100 text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
              Fale com a gente pelo WhatsApp ou email. Vamos te mostrar como
              nossos SaaS podem simplificar o dia a dia do seu negócio.
            </p>
